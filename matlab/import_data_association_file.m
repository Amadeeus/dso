function data = importDataAssociationFile(filename, startRow, endRow)
...
%
% Example:
%   data = import_data_association_file('data.txt', 1, 52087);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/02/06 16:05:59
...
formatSpec = '%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%[^\n\r]';
